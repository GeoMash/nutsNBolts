...
Use 3 dashes for an em-dash. Use 2 dashes for ranges (ex. "its all in
...
that last line which continues item 3 above). Heres a link to [a
website](http://foo.bar). Heres a link to a [local
doc](local-doc.html). Heres a footnote [^1].
...
(The above is the caption for the table.) Heres a definition list:
...
Done.			
			...
			echo $this->plugin->MarkDown->text($markDown);
		}
