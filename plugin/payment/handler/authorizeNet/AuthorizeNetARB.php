...
require_once 'shared/AuthorizeNetException.php';
require_once 'shared/AuthorizeNetRequest.php';
require_once 'shared/AuthorizeNetResponse.php';
...
class AuthorizeNetARB extends AuthorizeNetRequest
{
     ...
     */
    public function createSubscription(shared\AuthorizeNet_Subscription $subscription)
    {
     ...
     * @return AuthorizeNetARB_Response
     */
    public function updateSubscription($subscriptionId, shared\AuthorizeNet_Subscription $subscription)
    {
