						...
						<div class="padded">
							...
							<?php if ($tpl->get('extraOptions')['isAdding']): ?>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input data-role="selectUser" name="card_no" value=<?php $tpl->user_id; ?>>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input data-role="selectUser" name="ccv" value=<?php $tpl->user_id; ?>>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input data-role="selectUser" name="card_exp" value=<?php $tpl->user_id; ?>>
									</div>
								</div>
							<?php endif; ?>
						</div>
